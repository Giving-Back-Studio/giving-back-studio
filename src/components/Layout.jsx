      ...
      <header className="bg-transparent">
        <div className="container mx-auto px-4 py-4 flex justify-between items-center">
          ...
          <nav className="flex items-center space-x-6">
            ...
            <Link to="/apply" className="bg-[#262D8C] bg-opacity-60 border border-white border-opacity-50 text-white px-4 py-2 rounded-md transition-colors hover:bg-opacity-70">
              Apply to co-create
            </Link>
          </nav>
        </div>
